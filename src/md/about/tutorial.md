...
Nikita is written in JavaScript. To run your code, you must have Node.js and NPM installed. The procedure depends on your operating system. They are multiple alternatives to install Node.js:
...
A Nikita project is made of files. Everything is a file and it doesn't require you to rely on any external software such as a database. For this reason, it fits very well with [version control systems (VCS)](https://en.wikipedia.org/wiki/Version_control) such as [GIT](https://git-scm.com/) and [Mercurial](https://www.mercurial-scm.org/). In this tutorial, we will be using [GIT](https://git-scm.com/) and publish the source code to the [node-nikita-tutorial repository on GitHub](https://github.com/adaltas/node-nikita-tutorial).
